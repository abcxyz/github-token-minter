...
require (
	github.com/abcxyz/lumberjack v0.0.8-0.20240210025140-0513a63dc7b5
	github.com/abcxyz/pkg v0.7.4
...
require (
	...
	github.com/abcxyz/jvs v0.1.5-0.20240210023551-6bcca9e8619d // indirect
